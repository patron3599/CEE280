...
Analysis = CPBD_Analysis(nnodes,coord,concen,fixity,nele,ends,...
                A,Izz,Iyy,J,Cw,Zzz,Zyy,Ayy,Azz,E,v,Fy,YldSurf,Wt,webdir,...
                beta_ang,w,thermal,truss,anatype);

tic
RunAnalysis(Analysis,nnodes,concen,w,nele,fixity)
toc

[DEFL,REACT,ELE_FOR,AFLAG] = Analysis.RunAnalysis(nnodes,concen,w,nele,...
    fixity);
...
%% Classes called for this analysis 
% Node Class: 
